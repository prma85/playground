 ...
 */
$g_smtp_host        = '172.25.131.80';  # SMTP server MUST BE configured

# Configure using custom_config.inc.php
$g_tl_admin_email     = 'sistema@cagece.com.br'; # for problem/error notification
$g_from_email         = 'sistema@cagece.com.br';  # email sender
$g_return_path_email  = 'sistema@cagece.com.br';
...
$tlCfg->authentication['ldap_server'] = '172.25.131.112';
$tlCfg->authentication['ldap_port'] = '389';
$tlCfg->authentication['ldap_version'] = '3'; // could be '2' in some cases
$tlCfg->authentication['ldap_root_dn'] = 'DC=int,DC=cagece,DC=com,DC=br';
$tlCfg->authentication['ldap_bind_dn'] = 'CN=ldap,DC=int,DC=cagece,DC=com,DC=br'; // Left empty for anonymous LDAP binding
$tlCfg->authentication['ldap_bind_passwd'] = 'c@gece123'; // Left empty for anonymous LDAP binding
...
$tlCfg->logo_login = 'cagece.png';
$tlCfg->logo_navbar = 'cagece1.png';
 ...
 *
 **/
$g_repositoryPath = '/var/www/html/apps/testlink/upload_area';  /* unix example */
