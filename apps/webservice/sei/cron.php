...
//$request =  'http://cliquecagece/apps/gerencial/api/json';
//request to database in separete files
$request =  'http://cliquecagece/apps/sei/api/json/files';
//request to database in separete files
//$request =  'http://cliquecagece/apps/gerencial/api/json/files/atual';
