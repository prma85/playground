...
executeRequest('http://127.0.0.1/apps/webservice/sgr/json/indicadores', $log);
//request to database in separete files
//executeRequest('http://127.0.0.1/apps/sgr/api/json/files', $log);
executeRequest('http://127.0.0.1/apps/webservice/sgr/json/files', $log);
executeRequest('http://127.0.0.1/apps/webservice/sgr/json', $log);

//fecha o arquivo de log
$msg = " Tempo total de execuчуo: ".endExec()." s";
print_r($msg);
fwrite ($log,$msg." \r\n");
fwrite($log, "\r\n--------- Fim do processo ---------\r\n\r\n\r\n");
fclose($log);
